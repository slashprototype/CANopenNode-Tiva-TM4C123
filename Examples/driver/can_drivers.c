...
/*TODO: Modify this values for your specific CAN controller/node parameters*/
CO_ReturnError_t canopenInit(co_node_tm4c_t* p_node, uint32_t sys_clock_rate) {
    ...
    p_node->can_rx_fifo_buffer_size =
        16; /* CAN RX MSG Object FIFO Buffer initialization (16 CAN Msg Objects are implemented)*/
    p_node->can_tx_buffer_size = 16;
