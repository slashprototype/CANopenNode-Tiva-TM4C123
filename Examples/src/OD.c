...
OD_ATTR_RAM OD_RAM_t OD_RAM = {
    ...
    .x2000_blinkingFrequency = 0x0000,
    .x2100_counterPowerOnSeconds = 0x00000000
};
...
typedef struct {
    ...
    OD_obj_var_t o_2000_blinkingFrequency;
    OD_obj_var_t o_2100_counterPowerOnSeconds;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_2000_blinkingFrequency = {
        .dataOrig = &OD_RAM.x2000_blinkingFrequency,
        .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
        .dataLength = 2
    },
    .o_2100_counterPowerOnSeconds = {
        .dataOrig = &OD_RAM.x2100_counterPowerOnSeconds,
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x2000, 0x01, ODT_VAR, &ODObjs.o_2000_blinkingFrequency, NULL},
    {0x2100, 0x01, ODT_VAR, &ODObjs.o_2100_counterPowerOnSeconds, NULL},
