...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x1A04_TPDOMappingParameter = {
        ...
        .applicationObject1 = 0x26000010,
        .applicationObject2 = 0x26010008,
        .applicationObject3 = 0x00000000,
        .applicationObject4 = 0x00000000,
        .applicationObject5 = 0x00000000,
        .applicationObject6 = 0x00000000,
...
OD_ATTR_RAM OD_RAM_t OD_RAM = {
    ...
    .x2401_co_hp_motor_status = 0x00,
    .x2402_co_hp_heparine_adm = 0x00,
    .x2403_co_hp_acum_time = 0x0000,
    .x2404_co_hp_pump_test = 0x00,
    .x2501_co_hp_buttons_status = 0x00,
    .x2502_co_hp_syringe_type = 0x00,
    .x2503_co_hp_heparin_flow = 0x00,
    .x2504_co_hp_heparin_bolus = 0x00,
    .x2505_co_hp_desired_time = 0x0000,
    .x2600_co_bps_encoder = 0x0000,
    .x2601_co_bps_status_door = 0x00,
    .x2700_co_bps_setpoint = 0x0000,
    .x2701_co_bps_diammeter_hose = 0x00,
    .x2702_co_bps_start_stop = 0x00,
...
typedef struct {
    ...
    OD_obj_var_t o_2401_co_hp_motor_status;
    OD_obj_var_t o_2402_co_hp_heparine_adm;
    OD_obj_var_t o_2403_co_hp_acum_time;
    OD_obj_var_t o_2404_co_hp_pump_test;
    OD_obj_var_t o_2501_co_hp_buttons_status;
    OD_obj_var_t o_2502_co_hp_syringe_type;
    OD_obj_var_t o_2503_co_hp_heparin_flow;
    OD_obj_var_t o_2504_co_hp_heparin_bolus;
    OD_obj_var_t o_2505_co_hp_desired_time;
    OD_obj_var_t o_2600_co_bps_encoder;
    OD_obj_var_t o_2601_co_bps_status_door;
    OD_obj_var_t o_2700_co_bps_setpoint;
    OD_obj_var_t o_2701_co_bps_diammeter_hose;
    OD_obj_var_t o_2702_co_bps_start_stop;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_2401_co_hp_motor_status = {
        .dataOrig = &OD_RAM.x2401_co_hp_motor_status,
        .attribute = ODA_SDO_RW | ODA_TPDO,
        .dataLength = 1
    },
    .o_2402_co_hp_heparine_adm = {
        .dataOrig = &OD_RAM.x2402_co_hp_heparine_adm,
        .attribute = ODA_SDO_RW | ODA_TPDO,
        .dataLength = 1
    },
    .o_2403_co_hp_acum_time = {
        .dataOrig = &OD_RAM.x2403_co_hp_acum_time,
        .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
        .dataLength = 2
    },
    .o_2404_co_hp_pump_test = {
        .dataOrig = &OD_RAM.x2404_co_hp_pump_test,
        .attribute = ODA_SDO_RW | ODA_TPDO,
        .dataLength = 1
    },
    .o_2501_co_hp_buttons_status = {
        .dataOrig = &OD_RAM.x2501_co_hp_buttons_status,
        .attribute = ODA_SDO_RW | ODA_RPDO,
        .dataLength = 1
    },
    .o_2502_co_hp_syringe_type = {
        .dataOrig = &OD_RAM.x2502_co_hp_syringe_type,
        .attribute = ODA_SDO_RW | ODA_RPDO,
        .dataLength = 1
    },
    .o_2503_co_hp_heparin_flow = {
        .dataOrig = &OD_RAM.x2503_co_hp_heparin_flow,
        .attribute = ODA_SDO_RW | ODA_RPDO,
        .dataLength = 1
    },
    .o_2504_co_hp_heparin_bolus = {
        .dataOrig = &OD_RAM.x2504_co_hp_heparin_bolus,
        .attribute = ODA_SDO_RW | ODA_RPDO,
        .dataLength = 1
    },
    .o_2505_co_hp_desired_time = {
        .dataOrig = &OD_RAM.x2505_co_hp_desired_time,
        .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
        .dataLength = 2
    },
    .o_2600_co_bps_encoder = {
        .dataOrig = &OD_RAM.x2600_co_bps_encoder,
        .attribute = ODA_SDO_RW | ODA_TPDO | ODA_MB,
        .dataLength = 2
    },
    .o_2601_co_bps_status_door = {
        .dataOrig = &OD_RAM.x2601_co_bps_status_door,
        .attribute = ODA_SDO_RW | ODA_TPDO,
        .dataLength = 1
    },
    .o_2700_co_bps_setpoint = {
        .dataOrig = &OD_RAM.x2700_co_bps_setpoint,
        .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
        .dataLength = 2
    },
    .o_2701_co_bps_diammeter_hose = {
        .dataOrig = &OD_RAM.x2701_co_bps_diammeter_hose,
        .attribute = ODA_SDO_RW | ODA_RPDO,
        .dataLength = 1
    },
    .o_2702_co_bps_start_stop = {
        .dataOrig = &OD_RAM.x2702_co_bps_start_stop,
        .attribute = ODA_SDO_RW | ODA_RPDO,
        .dataLength = 1
    },
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x2401, 0x01, ODT_VAR, &ODObjs.o_2401_co_hp_motor_status, NULL},
    {0x2402, 0x01, ODT_VAR, &ODObjs.o_2402_co_hp_heparine_adm, NULL},
    {0x2403, 0x01, ODT_VAR, &ODObjs.o_2403_co_hp_acum_time, NULL},
    {0x2404, 0x01, ODT_VAR, &ODObjs.o_2404_co_hp_pump_test, NULL},
    {0x2501, 0x01, ODT_VAR, &ODObjs.o_2501_co_hp_buttons_status, NULL},
    {0x2502, 0x01, ODT_VAR, &ODObjs.o_2502_co_hp_syringe_type, NULL},
    {0x2503, 0x01, ODT_VAR, &ODObjs.o_2503_co_hp_heparin_flow, NULL},
    {0x2504, 0x01, ODT_VAR, &ODObjs.o_2504_co_hp_heparin_bolus, NULL},
    {0x2505, 0x01, ODT_VAR, &ODObjs.o_2505_co_hp_desired_time, NULL},
    {0x2600, 0x01, ODT_VAR, &ODObjs.o_2600_co_bps_encoder, NULL},
    {0x2601, 0x01, ODT_VAR, &ODObjs.o_2601_co_bps_status_door, NULL},
    {0x2700, 0x01, ODT_VAR, &ODObjs.o_2700_co_bps_setpoint, NULL},
    {0x2701, 0x01, ODT_VAR, &ODObjs.o_2701_co_bps_diammeter_hose, NULL},
    {0x2702, 0x01, ODT_VAR, &ODObjs.o_2702_co_bps_start_stop, NULL},
