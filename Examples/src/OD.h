...
********************************************************************************
    ...
    File info:
        ...
        Project File: CO_Editor_Profile.xdd
        File Version: 1.0

        Created:      11/23/2020 5:00:00 AM
        Created By:   Slashprototype
        Modified:     1/23/2025 9:52:34 AM
        Modified By:  Slashprototype

    Device Info:
        Vendor Name:  Slashprototype
        Vendor ID:    01
        Product Name: Tiva_TM4C123_MCU
        Product ID:   01

        Description:  Driver for TM4C123 Tiva Launchpad with CANopenNode example
*******************************************************************************/
...
typedef struct {
    ...
    uint16_t x2000_blinkingFrequency;
    uint32_t x2100_counterPowerOnSeconds;
} OD_RAM_t;
...
#define OD_ENTRY_H2100 &OD->list[34]
...
#define OD_ENTRY_H2000_blinkingFrequency &OD->list[33]
#define OD_ENTRY_H2100_counterPowerOnSeconds &OD->list[34]
